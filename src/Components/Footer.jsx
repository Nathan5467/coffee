    ...
    <div className=" bg-gradient-to-r from-[#FFDCAB] to-[#AB6B2E] text-black rounded-t-3xl mt-8 md:mt-0">
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
        <div className=" w-full md:w-1/4">
          ...
          <p className=" text-sm">
          Welcome to Cafe Pulse!
Dive into a world of aromatic brews and artisanal flavors. Discover the perfect roast to uplift your senses and make every sip a celebration of your daily ritual.
